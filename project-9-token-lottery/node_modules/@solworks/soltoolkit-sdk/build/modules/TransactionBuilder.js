...
class TransactionBuilder {
    ...
    addSplTransferIxByOwners({ mint, fromOwner, toOwner, rawAmount, additionalSigners }) {
        // get associated token accounts
        const fromTokenAccount = (0, spl_token_1.getAssociatedTokenAddressSync)(mint, fromOwner);
        const toTokenAccount = (0, spl_token_1.getAssociatedTokenAddressSync)(mint, toOwner);
        // create transfer instruction
        const ix = (0, spl_token_1.createTransferInstruction)(fromTokenAccount, toTokenAccount, fromOwner, rawAmount, additionalSigners);
    ...
    addComputeBudgetIx({ units, priceInMicroLamports }) {
