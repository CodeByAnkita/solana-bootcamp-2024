...
class TransactionWrapper {
    ...
    sendAndConfirm({ serialisedTx, maximumRetries = 5, commitment = 'max', skipPreflight = false }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (tries < maximumRetries && // not exceeded max retries
                ...
                try {
                    signature = yield this.sendTx({ serialisedTx, skipPreflight });
                    ...
                    if (e instanceof web3_js_1.SendTransactionError) {
                        console.log('Error transferring to temp pool', e.getLogs(this._connection));
                        throw e;
                    }
    ...
    addBlockhashAndFeePayer(feePayer, commitment) {
        return __awaiter(this, void 0, void 0, function* () {
            const latestBlockhash = yield this._connection.getLatestBlockhash(commitment !== null && commitment !== void 0 ? commitment : 'max');
    ...
    sendTx({ serialisedTx, skipPreflight = false }) {
        return __awaiter(this, void 0, void 0, function* () {
...
function sendTxUsingJito({ serializedTx, region = 'mainnet' }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let res = yield (0, node_fetch_1.default)(`${rpcEndpoint}/transactions?bundleOnly=true`, {
            method: 'POST',
