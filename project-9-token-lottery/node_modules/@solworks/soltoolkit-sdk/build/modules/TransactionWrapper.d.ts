...
export declare class TransactionWrapper {
    ...
    sendAndConfirm({ serialisedTx, maximumRetries, commitment, skipPreflight }: {
        serialisedTx: Uint8Array | Buffer | number[];
        maximumRetries?: number;
        commitment?: Commitment;
        skipPreflight?: boolean;
    }): Promise<string>;
    addBlockhashAndFeePayer(feePayer?: PublicKey, commitment?: Commitment): Promise<TransactionWrapper>;
    sign({ wallet, signers, txs }: {
        wallet?: IWallet;
        signers?: Signer[];
        txs?: Transaction[];
    }): Promise<Transaction[]>;
    sendTx({ serialisedTx, skipPreflight }: {
        serialisedTx: Uint8Array | Buffer | number[];
        skipPreflight?: boolean;
    }): Promise<string>;
