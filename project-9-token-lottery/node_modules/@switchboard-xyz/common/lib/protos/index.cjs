    ...
    oracle_job.OracleJob = (function () {
      ...
      return GlyphTask.fromObject(properties);
        ...
        GlyphTask.encode = function encode(message, writer) {
          if (!writer) writer = $Writer.create();
          if (
            message.poolAddress != null &&
            Object.hasOwnProperty.call(message, "poolAddress")
          )
            writer
              .uint32(/* id 1, wireType 2 =*/ 10)
              .string(message.poolAddress);
          if (
            message.zeroForOne != null &&
            Object.hasOwnProperty.call(message, "zeroForOne")
          )
      ...
      OracleJob.SolayerSusdTask = (function () {
         ...
         * @memberof oracle_job.OracleJob
         * @classdesc Represents a SolayerSusdTask.
      ...
      return SolayerSusdTask.fromObject(properties);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SolayerSusdTask.encodeDelimited = function encodeDelimited(
          message,
          writer
        ) {
          return this.encode(message, writer).ldelim();
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SolayerSusdTask.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.oracle_job.OracleJob.SolayerSusdTask();
          while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
              default:
      ...
      return Task.fromObject(properties);
        ...
        Task.encode = function encode(message, writer) {
          ...
          if (
            message.solayerSusdTask != null &&
            Object.hasOwnProperty.call(message, "solayerSusdTask")
          )
            $root.oracle_job.OracleJob.SolayerSusdTask.encode(
              message.solayerSusdTask,
              writer.uint32(/* id 56, wireType 2 =*/ 450).fork()
            ).ldelim();
          return writer;
        };
        ...
        Task.decode = function decode(reader, length) {
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              ...
              case 56: {
                message.solayerSusdTask =
                  $root.oracle_job.OracleJob.SolayerSusdTask.decode(
                    reader,
                    reader.uint32()
                  );
                break;
        ...
        Task.verify = function verify(message) {
          ...
          if (
            message.solayerSusdTask != null &&
            message.hasOwnProperty("solayerSusdTask")
          ) {
            if (properties.Task === 1) return "Task: multiple values";
            properties.Task = 1;
            {
              var error = $root.oracle_job.OracleJob.SolayerSusdTask.verify(
                message.solayerSusdTask
              );
              if (error) return "solayerSusdTask." + error;
            }
          }
          return null;
        };
        ...
        Task.fromObject = function fromObject(object) {
          ...
          if (object.solayerSusdTask != null) {
            if (typeof object.solayerSusdTask !== "object")
              throw TypeError(
                ".oracle_job.OracleJob.Task.solayerSusdTask: object expected"
              );
            message.solayerSusdTask =
              $root.oracle_job.OracleJob.SolayerSusdTask.fromObject(
                object.solayerSusdTask
              );
          }
          return message;
        };
        ...
        Task.toObject = function toObject(message, options) {
          ...
          if (
            ...
            object.solayerSusdTask =
              $root.oracle_job.OracleJob.SolayerSusdTask.toObject(
                message.solayerSusdTask,
                options
              );
            if (options.oneofs) object.Task = "solayerSusdTask";
          }
          return object;
        };
