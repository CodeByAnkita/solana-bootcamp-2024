...
function simulateFeed(params, queue) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = (yield gateway.fetchSignatures(Object.assign(Object.assign({}, params), { useTimestamp: true, recentHash: bs58_1.default.encode(Buffer.from((_b = params.recentHash) !== null && _b !== void 0 ? _b : "0".repeat(64), "hex")) }))).responses[0];
        return {
...
function getUpdate(params, queue) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const gateway = (_a = params.gateway) !== null && _a !== void 0 ? _a : (yield queue.fetchGateway());
        const { responses, failures } = yield gateway.fetchSignatures(Object.assign(Object.assign({}, params), { useTimestamp: true, recentHash: bs58_1.default.encode(Buffer.from(params.recentHash, "hex")) }));
        const response = [];
